 ...
 * @author user
 */
public class login_panitia extends javax.swing.JFrame {

    /**
     * Creates new form login_admin
     */
    public login_panitia() {
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Login Panitia");
    }
    public void bersih(){
        username.setText("");
        password.setText("");
    ...
    private void masukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_masukActionPerformed
        try{
         Statement perintah = (Statement) koneksi.GetConnection().createStatement();
          String sql = "SELECT * FROM panitia WHERE username='"+username.getText()+"' AND password='"+password.getText()+"'";
 ...
 setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(login_panitia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new login_panitia().setVisible(true);
            }
        });
    }
